...
public class ServiceErrorHandler {
    ...
    public ResponseEntity<Object> handleIllegalStateException(IllegalStateException ex, WebRequest request) {
        return new ResponseEntity<>(GenericResponse.<String>builder().bodyOut(ex.getMessage()).code(HttpStatus.INTERNAL_SERVER_ERROR.value()).message("Error"), HttpStatus.INTERNAL_SERVER_ERROR);
    }
    ...
    public ResponseEntity<Object> handleDataIntegrityViolation(DataIntegrityViolationException ex, WebRequest request) {
        ...
        return new ResponseEntity<>(GenericResponse.<String>builder().bodyOut(ex.getMessage()).code(HttpStatus.INTERNAL_SERVER_ERROR.value()).message(message), HttpStatus.INTERNAL_SERVER_ERROR);
    }
